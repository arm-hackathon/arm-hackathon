...
out=root/'out'/'helios-qual-v2'/'corpus-preflight-one-pair'
print(run_pilot_campaign(root,design,c,preflight=p,output_root=out,pair_limit=1,worker_count=1,resume=False))
